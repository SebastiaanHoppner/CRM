crm_compare <- function (formula, data, maxiter = 100, tolerance = 0.01, outlyingness.factor = 1,
                         spadieta = seq(0.9, 0.1, -0.1), center = "median", scale = "qn",
                         regtype = "MM", alphaLTS = NULL, seed = NULL, verbose = TRUE, 
                         weightfunction = "hampel", weightthreshold = 1) {
  # -----------------------------------------------------------------------------------------------
